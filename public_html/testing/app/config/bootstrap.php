...
$_SERVER['KERNEL_DIR'] = "{$root}/../../app/";

$config = array(
    /* Required */

    // The directory where PEAR is located
    'pear_path'      => "{$root}/../../vendor/phpunit/phpunit",

    // The directories where the tests reside
    'test_directories' => array(
        "{$root}/../../src/TS/ApiBundle/Tests/Controller",
        //"{$root}/../src",
    ),
