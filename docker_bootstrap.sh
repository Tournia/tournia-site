...
# Run apache with user&group root, to prevent problems with folder permissions
#sed -i 's/APACHE_RUN_USER=www-data/APACHE_RUN_USER=root/' /etc/apache2/envvars
#sed -i 's/APACHE_RUN_GROUP=www-data/APACHE_RUN_GROUP=root/' /etc/apache2/envvars
